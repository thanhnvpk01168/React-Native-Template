...
//         if (enableAnimation) {
//             animTranslateYValue.value = withSpring(maxHeight, { damping: 20 })
//         } else {
...
//         if (enableAnimation) {
//             animTranslateYValue.value = withSpring(0, { damping: 20 })
//         } else {
...
// export default ModalTest = memo(forwardRef(ModalComponent), isEqual);
